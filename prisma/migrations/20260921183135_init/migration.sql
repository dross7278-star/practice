...
-- CreateIndex
CREATE UNIQUE INDEX "Availability_providerId_dayOfWeek_startMinute_key" ON "Availability"("providerId", "dayOfWeek", "startMinute");

-- CreateIndex
CREATE INDEX "Booking_providerId_startsAt_idx" ON "Booking"("providerId", "startsAt");

-- CreateIndex
CREATE INDEX "Booking_clientId_startsAt_idx" ON "Booking"("clientId", "startsAt");

-- CreateIndex
CREATE UNIQUE INDEX "Booking_serviceId_startsAt_key" ON "Booking"("serviceId", "startsAt");
